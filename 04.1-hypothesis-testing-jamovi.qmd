...
#| fig-alt: Screenshot of the Jamovi interface showing setup for a one-sample t-test. The variable “dbp” is entered as the dependent variable and the hypothesised mean test value is set to 71. The analysis options panel for conducting a one-sample t-test is displayed.
...
#| fig-alt: Screenshot of Jamovi descriptive statistics output for the variable “dbp”. The table reports the sample size, mean, standard deviation, standard error, and 95% confidence interval for diastolic blood pressure.
