...
jamovi can be downloaded for no cost at [https://www.jamovi.org/download.html](https://www.jamovi.org/download.html) for Windows, macOS and linux. I recommend downloading the "current" release (not the "solid" release). At the time of writing, Version 2.7.24 is the appropriate version to use. Download and install jamovi in the usual way.

## A simple jamovi analysis

When you first open jamovi, it will look something like the following.

![](img/mod01/jamovi/simple-01.png){fig-alt="Screenshot of jamovi opening with the spreadsheet view on the left and the results panel on the right."}
...
![](img/mod01/jamovi/simple-02.png){fig-alt="Screenshot showing six ages entered down a single column in jamovi, with the default variable name A at the top."}
...
Let's rename our variable from `A` to `Age (years)`. There are a number of ways of doing this: here we will click the **Data** tab (at the top of the window) which allows us to change aspects of our dataset, and then click **Setup**. By default, the first column is selected - you can choose any column simply by clicking it.

![](img/mod01/jamovi/variables-01.png){fig-alt="Screenshot of the Data tab and Setup panel where the first variable column is selected for editing."}
...
![](img/mod01/jamovi/variables-02.png){fig-alt="Screenshot showing the variable name A being changed to Age (years) in the Setup panel."}
...
![](img/mod01/jamovi/variables-03.png){fig-alt="Screenshot of the Setup panel showing the measure type dropdown where a variable can be changed from nominal to continuous."}
...
![](img/mod01/jamovi/simple-03.png){fig-alt="Screenshot of the Descriptives analysis dialog with Age (years) selected in the Variables box."}
...
The unique thing about jamovi is that *all analyses are updated whenever the data are changed in the spreadsheet*. While this can be convinient, *care must be taken not to make any unintended changes to your data while in the spreadsheet view.*

jamovi also has a way of opening and saving data, using the three lines in the upper-left corner: ![](img/mod01/jamovi/three-lines.png){fig-alt="Small three-line menu icon used to open, save, and export data or output in jamovi."}. This collection of commands lets you open data, save data and export data and output.
...
1.  Locate the data set called `mod01_pbc.rds`. Click the file to download it, and then save it in a folder you will be able to locate later - for example, your OneDrive folder.
...
![](img/mod01/jamovi/summ-01.png){fig-alt="Screenshot of jamovi Descriptives output showing summary statistics for age, AST, and serum bilirubin."}
...
![](img/mod01/jamovi/summ-02.png){fig-alt="Screenshot of jamovi Descriptives output showing additional summary statistics for age, AST, and serum bilirubin."}
...
![](img/mod01/jamovi/densplot-all.png){fig-alt="Screenshot showing density plots for the three continuous variables listed in the Descriptives output."}
...
::: {layout-ncol=2}
![](img/mod01/jamovi/densplot-weight.png){fig-alt="Density plot of weights showing a small bump at an extreme high value, suggesting an unusual value."}

![](img/mod01/jamovi/boxplot-weight.png){fig-alt="Boxplot of weights with one extreme point far above the rest of the data, indicating an unusual value."}
:::
...
![](img/mod01/jamovi/outlier.png){width=40% fig-alt="Screenshot of the jamovi spreadsheet highlighting a very large value of 700.2 kg in record 58."}
