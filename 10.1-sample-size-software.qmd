...
Based on the information in Worked Example 10.3, the **Power** is `0.9` and **Significance level** is `0.05`, and the two proportions are entered as `0.35` and `0.25`. Define equal numbers in each group (**Ratio** of `1`).
